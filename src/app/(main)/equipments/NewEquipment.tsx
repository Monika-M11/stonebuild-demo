...
//   // ── DEMO: no API call — just reset + success toast ──
//   const confirmSubmit = () => {
//     setLoading(true);
//     setTimeout(() => {
//       toast.success("Equipment added successfully ✅");
...
//       setShowConfirm(false);
//       setFormData(null);
//     }, 500); // small delay so the modal close feels natural
//   };
...
//   // count non-empty equipment codes for the counter
//   const watchedCodes = watch("equipment_codes") || [];
//   const totalCount = useMemo(
//     () => watchedCodes.filter((c) => (c?.value || "").trim() !== "").length,
...
//             {/* RIGHT COLUMN — Equipment Codes (dynamic list) */}
//             <div className="space-y-6">
//               <h2 className="text-lg font-medium text-[#103BB5] mt-6">Equipment Codes</h2>
//               <div className="space-y-4">
//                 <div className="space-y-3">
