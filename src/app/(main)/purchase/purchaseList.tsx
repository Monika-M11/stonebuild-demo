...
const dummyEquipments: Equipment[] = [
  ...
  { id: 21, equipment_name: "XRF Analyzer", brand: "Olympus", model: "Vanta", status: "active", codes_count: 9, created_at: "2025-06-21" },
  { id: 22, equipment_name: "Jewelry Polisher", brand: "Suhner", model: "P-500", status: "inactive", codes_count: 4, created_at: "2025-06-22" },
];
